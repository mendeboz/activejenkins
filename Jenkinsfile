        ...
        // One or more steps need to be included within each condition's block.
            ...
            script {
                ...
                if (params.Deploy == 'qa' || params.Deploy == 'qa-us' ){
                    ...
                    echo "build job: Deploy-Job, parameters: [ extendedChoice(name: 'DEPLOY_TARGET', value:  ${DEPLOY_TARGET}), string(name: 'SERVICE_LIST_CONFIG_FILE_BRANCH', value: ${FROM_BRANCH}),hidden(name: 'VERSION', value: ARTIFACT_VERSION), hidden(name: 'REPO', value: ${REPO}),string(name: 'params.JDK', value: ${params.JDK}),  string(name: 'ROLLING_DEPLOYMENT', value: 'true') ]"
